...
const LoginForm = ({ setView }) => {
    ...
    return (
        <div className="flex flex-col animate-fade-in">
            ...
            <p className="text-slate-500 mb-6 text-sm">Please enter your details to sign in.</p>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-1">
                ...
                <div className="flex justify-between items-center mt-2 mb-6 text-sm">
                    ...
                    <button type="button" onClick={() => setView('forgot')} className="text-blue-600 hover:text-blue-700 font-medium transition-colors">
                        Forgot Password?
                    </button>
                </div>

                <Button type="submit" isLoading={isLoading} disabled={!email || !password}>
                    Sign In
                </Button>
            </form>

            <div className="mt-6 flex items-center before:mt-0.5 before:flex-1 before:border-t before:border-slate-200 after:mt-0.5 after:flex-1 after:border-t after:border-slate-200">
