...
// ✅ ResetPasswordForm removed — ForgotPasswordForm handles all 3 steps inline
  ...
  const renderForm = () => {
    switch (activeTab) {
      ...
      case 'forgot':   return <ForgotPasswordForm setView={setActiveTab} />;
        // ✅ FIXED: removed 'reset' case — it routed to the unused ResetPasswordForm.
        //    ForgotPasswordForm's internal step 3 handles password reset already.
